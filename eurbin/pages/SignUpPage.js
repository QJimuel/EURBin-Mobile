  ...
  const handleDropdownOpen = (dropdown) => {
    setRoleOpen(dropdown === 'role' ? !roleOpen : false);
    setDepartmentOpen(dropdown === 'department' ? !departmentOpen : false);
    setYearLevelOpen(dropdown === 'yearLevel' ? !yearLevelOpen : false);
    setProgramOpen(dropdown === 'program' ? !programOpen : false);
  };
...
<View style={{ zIndex: 1000 }}>
  <DropDownPicker
    ...
    value={role}
    items={roleOptions}
    setOpen={() => handleDropdownOpen('role')}
    setValue={setRole}
    placeholder="Role"
  ...
  <>
    <View style={styles.nameRole1}>
      <View style={{ zIndex: departmentOpen ? 800 : 1 }}>
        <DropDownPicker
          ...
          setOpen={() => handleDropdownOpen('department')}
      ...
      <View style={{ zIndex: yearLevelOpen ? 700 : 1 }}>
        <DropDownPicker
          ...
          setOpen={() => handleDropdownOpen('yearLevel')}
          setValue={setYearLevel}
          placeholder="Year Level"
          style={styles.dropdown}
          dropDownContainerStyle={styles.dropdownContainer}
          onChangeValue={(value) => setYearLevel(value)}
        />
      </View>
    </View>
    ...
    <View style={{ zIndex: programOpen ? 600 : 1 }}>
      <DropDownPicker
        ...
        setOpen={() => handleDropdownOpen('program')}
        setValue={setProgram}
        placeholder="Program"
        style={styles.dropdown3}
        dropDownContainerStyle={styles.dropdownContainer}
        disabled={!department}
        onChangeValue={(value) => setProgram(value)}
      />
    </View>
  </>
)}
